                                        ...
                                        <Table class="table table-hover table-borderless table-striped">
                                            <thead>
                                              <tr>
                                                ...
                                                <th scope="col">1X</th>
                                                <th scope="col">Double Chance <br />12</th>
                                                <th scope="col">X2</th>
                                                <th scope="col">0.5</th>
                                                <th scope="col">1.5</th>
                                                <th scope="col">Under | Over <br />2.5</th>
                                                <th scope="col">3.5</th>
                                                <th scope="col">4+</th>
                                                <th scope="col">Win</th>
                                                <th scope="col">1 st half <br />Draw</th>
                                                <th scope="col">Loss</th>
                                                <th scope="col">Win</th>
                                                <th scope="col">2 nd half <br />Draw</th>
                                                <th scope="col">Loss</th>
                                                <th scope="col">0</th>
                                                <th scope="col">1</th>
                                                <th scope="col">Goals 1st | 2nd half <br />2</th>
                                                <th scope="col">3</th>
                                                <th scope="col">4+</th>
                                                <th scope="col">+</th>
                                              </tr>
